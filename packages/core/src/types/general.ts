...
import type { PinType, ConnectingPin } from './pins'
...
export type ReactFlowStore = {
  ...
  connectionPinId: string | null
  connectionPinType: PinType | null
  ...
  connectionStartPin: ConnectingPin | null
  connectionEndPin: ConnectingPin | null
  // @todo this is only used for the click connection - we might remove this in the next major version
  connectionClickStartPin: ConnectingPin | null
