...
import type { XYPosition, Position, CoordinateExtent, PinElement } from '.'
...
export type WrapNodeProps<T = any> = Pick<
  Node<T>,
  'id' | 'data' | 'style' | 'className' | 'dragHandle' | 'outputPosition' | 'inputPosition' | 'hidden' | 'ariaLabel'
> &
...
export type NodePinBounds = {
  output: PinElement[] | null
  input: PinElement[] | null
}
