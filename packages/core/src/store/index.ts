...
import { getPinBounds } from '../components/Nodes/utils'
  ...
  createStore<ReactFlowState>((set, get) => ({
          ...
          if (doUpdate) {
            nodeInternals.set(node.id, {
              ...
              [internalsSymbol]: {
                ...
                pinBounds: {
                  output: getPinBounds('.output', update.nodeElement, zoom, nodeOrigin),
                  input: getPinBounds('.input', update.nodeElement, zoom, nodeOrigin),
                },
              },
              ...dimensions,
            })
    ...
    cancelConnection: () =>
      set({
        ...
        connectionPinId: initialState.connectionPinId,
        connectionPinType: initialState.connectionPinType,
        connectionStatus: initialState.connectionStatus,
        connectionStartPin: initialState.connectionStartPin,
        connectionEndPin: initialState.connectionEndPin,
      }),
